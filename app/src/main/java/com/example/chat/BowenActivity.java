...
public class BowenActivity extends AppCompatActivity {
    private static final String TABLE_NAME = "Bowenmessage";
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        dbhelper = new ChatDBhelper(BowenActivity.this);

        headlinetext.setText("Bowen");
        ...
        button_send.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View view) {
                ...
                if (TextUtils.isEmpty(content)) {
                    Toast.makeText(BowenActivity.this, "内容为空", Toast.LENGTH_SHORT).show();
                } else {
                    boolean flag = dbhelper.insertData(content, TABLE_NAME);
                    if (flag) {
                        editText.setText("");
                        Toast.makeText(BowenActivity.this, "添加成功", Toast.LENGTH_SHORT).show();
                        init();
                    } else {
                        Toast.makeText(BowenActivity.this, "添加失败", Toast.LENGTH_SHORT).show();
                    }
                }
            }
        });
        deleteButton.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View view) {
                ...
                AlertDialog.Builder builder = new AlertDialog.Builder(BowenActivity.this);
                builder.setTitle("删除聊天记录")
                        ...
                        .setPositiveButton("确定", new DialogInterface.OnClickListener() {
                            ...
                            public void onClick(DialogInterface dialog, int which) {
                                ...
                                if (flag) {
                                    Toast.makeText(BowenActivity.this, "往事随云烟，薄奠", Toast.LENGTH_SHORT).show();
                                    msgList.clear();
                                    init();
                                } else {
                                    Toast.makeText(BowenActivity.this, "删除失败", Toast.LENGTH_SHORT).show();
                                }
                            }
                        })
        ...
        backButton.setOnClickListener(new View.OnClickListener() {
            @Override
            public void onClick(View view) {
                Intent intent = new Intent(BowenActivity.this, MainActivity.class);
    ...
    private void setupAdapter() {
        if (adapter == null) {
            adapter = new ChatAdapter(BowenActivity.this);
