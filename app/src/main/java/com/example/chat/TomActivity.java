...
public class TomActivity extends AppCompatActivity {
    private static final String TABLE_NAME = "Tommessage";
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        dbhelper = new ChatDBhelper(TomActivity.this);

        headlinetext.setText("Tom");
        ...
        button_send.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View view) {
                ...
                if (TextUtils.isEmpty(content)) {
                    Toast.makeText(TomActivity.this, "内容为空", Toast.LENGTH_SHORT).show();
                } else {
                    boolean flag = dbhelper.insertData(content, TABLE_NAME,time);
                    if (flag) {
                        editText.setText("");
                        Toast.makeText(TomActivity.this, "添加成功", Toast.LENGTH_SHORT).show();
                        init();
                    } else {
                        Toast.makeText(TomActivity.this, "添加失败", Toast.LENGTH_SHORT).show();
                    }
                }
            }
        });
        ...
        backButton.setOnClickListener(new View.OnClickListener() {
            @Override
            public void onClick(View view) {
                Intent intent = new Intent(TomActivity.this, MainActivity.class);
    ...
    private void setupAdapter() {
        if (adapter == null) {
            adapter = new ChatAdapter(TomActivity.this);
